...
class StarsServiceTest {
    ...
    void createStar_NewName_SavesAndCaches() {
        StarDto inputDto = new StarDto(0, "Sun", "G-type", 1.0, 1.0, 5778.0, 1.0, 0.0, 0.0, "Center", null,null);
        ...
        savedEntity.setId(1);
        StarDto savedDto = new StarDto(1, "Sun", "G-type", 1.0, 1.0, 5778.0, 1.0, 0.0, 0.0, "Center", null, null);
    ...
    void createStars_AllNew_SavesAndCaches() {
        StarDto dto1 = new StarDto(0, "Star1", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
        StarDto dto2 = new StarDto(0, "Star2", "Type", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos", null, null);
        ...
        StarDto savedDto1 = new StarDto(1, "Star1", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
        StarDto savedDto2 = new StarDto(2, "Star2", "Type", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos", null, null);
    ...
    void createStars_SomeExist_ThrowsException() {
        StarDto dto = new StarDto(0, "ExistingStar", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarById_InCache_ReturnsCached() {
        StarDto cachedDto = new StarDto(1, "Sun", "G-type", 1.0, 1.0, 5778.0, 1.0, 0.0, 0.0, "Center", null, null);
    ...
    void getStarById_NotInCache_FetchesAndCaches() {
        Star entity = new Star("Sun", "G-type", 1.0, 1.0, 5778.0, 1.0, 0.0, 0.0, "Center");
        entity.setId(1);
        StarDto dto = new StarDto(1, "Sun", "G-type", 1.0, 1.0, 5778.0, 1.0, 0.0, 0.0, "Center", null, null);
    ...
    void putStar_NonExistentId_ThrowsResourceNotFound() {
        StarDto inputDto = new StarDto(999, "NewStar", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithPagination_ReturnsPagedResults() {
        ...
        when(starMapper.mapToDto(star1)).thenReturn(new StarDto(1, "Star1", "Type1", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos1", null, null));
        when(starMapper.mapToDto(star2)).thenReturn(new StarDto(2, "Star2", "Type2", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos2", null, null));
    ...
    void getStarsByCriteria_WithoutPagination_ReturnsAllResults() {
        ...
        when(starMapper.mapToDto(star)).thenReturn(new StarDto(1, "Star", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null));
    ...
    void getStarsByCriteria_UpdatesCacheForNewEntries() {
        ...
        star.setId(1);
        StarDto starDto = new StarDto(1, "NewStar", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithType_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", type, 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithMass_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type1", mass, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithNameAndType_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, name, type, 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_NoCriteria_ReturnsAllStars() {
        ...
        when(starMapper.mapToDto(star1)).thenReturn(new StarDto(1, "Star1", "Type1", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null));
        when(starMapper.mapToDto(star2)).thenReturn(new StarDto(2, "Star2", "Type2", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos", null, null));
    ...
    void getStarsByCriteria_WithSomeCachedStars_UpdatesCacheForNewEntries() {
        ...
        cachedStar.setId(1);
        StarDto cachedDto = new StarDto(1, "CachedStar", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);

        Star newStar = new Star("NewStar", "Type", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos");
        newStar.setId(2);
        StarDto newDto = new StarDto(2, "NewStar", "Type", 2.0, 2.0, 6000.0, 2.0, 1.0, 1.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithRadius_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, radius, 5000.0, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithTemperature_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, 1.0, temperature, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithLuminosity_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, 1.0, 5000.0, luminosity, 0.0, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithRightAscension_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, 1.0, 5000.0, 1.0, rightAscension, 0.0, "Pos", null, null);
    ...
    void getStarsByCriteria_WithDeclination_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, declination, "Pos", null, null);
    ...
    void getStarsByCriteria_WithPositionInConstellation_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, 1.0, 5000.0, 1.0, 0.0, 0.0, position, null, null);
    ...
    void getStarsByCriteria_WithRadiusAndTemperature_ReturnsFilteredResults() {
        ...
        star.setId(1);
        StarDto dto = new StarDto(1, "Star1", "Type", 1.0, radius, temperature, 1.0, 0.0, 0.0, "Pos", null, null);
    ...
    void patchStar_UpdateSingleField_PreservesOtherValues() {
        ...
        when(starMapper.mapToDto(any())).thenAnswer(inv -> {
            ...
            return new StarDto(s.getId(), s.getName(), s.getType(), s.getMass(),
                    ...
                    s.getRightAscension(), s.getDeclination(), s.getPositionInConstellation(), null, null);
        });
